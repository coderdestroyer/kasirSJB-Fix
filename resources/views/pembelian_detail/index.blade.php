                        ...
                        <div class="col-lg-4">
                            <form action="{{ route('pembelian.store') }}" class="form-pembelian" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" id="bayarrp" name="bayarrp" class="form-control">
                                    </div>
                                </div>
                            </form>
                        </div>
    ...
    <script>
        ...
        $(function() {
            ...
            $(document).on('change', '.uom-select', function() {
                ...
                // Kirimkan request POST untuk mengupdate UOM
                $.post(`{{ url('/cart_pembelian') }}/${id}/update_uom`, {
                        '_token': $('[name=csrf-token]').attr('content'),
                        '_method': 'put',
                        'uom': uom
                    })
                    .done(response => {
                        // Refresh tabel setelah update berhasil
                        table.ajax.reload(() => loadForm());
                    })
                    .fail(errors => {
                        alert('Tidak dapat menyimpan data');
